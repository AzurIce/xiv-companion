...
pub use model::{
    ...
    PackedModelId, PreparedMaterial, PreparedMaterialFeatureFlags, PreparedMaterialUvSources,
    PreparedMesh, PreparedMeshShapeInfluences, PreparedMeshVisibility, PreparedModel,
    PreparedModelOptions, PreparedRenderPass, PreparedTextureAddressMode, PreparedTextureBindings,
