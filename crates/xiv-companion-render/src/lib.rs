...
pub use model::{
    ...
    PreparedMaterialFeatureFlags, PreparedRenderPass, PreparedTextureAddressMode,
    PreparedTextureBindings, PreparedTextureColorSpace, PreparedTextureFilter,
    PreparedTextureSampling, PreparedTextureSamplingSet, WeaponCatalogCounts, WeaponCatalogItem,
