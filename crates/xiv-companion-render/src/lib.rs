...
pub use model::{
    ...
    PreparedMaterialFeatureFlags, PreparedMaterialUvSources, PreparedRenderPass,
    PreparedTextureAddressMode, PreparedTextureBindings, PreparedTextureColorSpace,
    PreparedTextureFilter, PreparedTextureSampling, PreparedTextureSamplingSet,
    ...
    mesh_draw_role_for_category, prepare_material_for_draw_role, prepared_material_feature_flags,
