...
pub fn Icon(kind: IconKind, #[props(default = "h-4 w-4")] class: &'static str) -> Element {
    match kind {
        ...
        IconKind::Github => render_icon(LdGithub, class),
        ...
        IconKind::Minus => render_icon(LdMinus, class),
        ...
        IconKind::PersonStanding => render_icon(LdPersonStanding, class),
        ...
        IconKind::User => render_icon(LdUser, class),
