pub use xiv_companion_data::model::{
    ...
    ModelTextureKind, ModelVertex, PackedModelId, PreparedMaterial, PreparedRenderPass,
    ...
    prepare_material_for_draw_role, weapon_material_candidate_paths, weapon_model_candidate_paths,
    weapon_slot_label,
};
