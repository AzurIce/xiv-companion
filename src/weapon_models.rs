pub use xiv_companion_data::model::{
    ...
    MaterialDecalColorMode, MaterialLightShaftType, MaterialRenderMode, MaterialShaderFamily,
    MaterialSkinValueMode, MaterialSubColorMode, ModelBounds, ModelData, ModelMaterial,
...
pub use xiv_companion_data::weapon_models::{
    ...
    WeaponModelLoadRequest, WeaponStainingTemplates, apply_weapon_model_stains,
