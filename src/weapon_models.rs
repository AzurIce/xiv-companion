pub use xiv_companion_data::model::{
    ...
    PackedEquipmentModelId, PackedModelId, PreparedMaterial, PreparedMaterialFeatureFlags,
    ...
    PreparedMaterialUvSources, PreparedMesh, PreparedMeshShapeInfluences, PreparedMeshVisibility,
    PreparedModel, PreparedModelOptions, PreparedModelRuntimeGeometryRequirements,
    ...
    StainingApplicationReport, WEAPON_CATALOG_SCHEMA_REVISION, WeaponCatalogCounts,
    ...
    equipment_slot_info, is_weapon_equip_slot_category, material_color, material_shader_family,
    mesh_draw_role_for_category, model_attribute_options, prepare_material_for_draw_role,
    ...
    prepared_material_runtime_fallbacks, prepared_material_runtime_input_requirements,
    prepared_material_unsupported_inputs, prepared_model_runtime_geometry_requirements,
...
pub use xiv_companion_data::weapon_models::{
    AsyncGameResource, CharaModelData, CharaModelLoadRequest, EquipmentModelData,
    EquipmentModelLoadRequest, FurnitureModelData, FurnitureModelLoadRequest,
    MaterialResolvedConstantDebug, MaterialResolvedShaderKeyDebug, MaterialSamplerFlagSummaryDebug,
    MaterialSemanticSummaryDebug, MaterialTextureFlagSummaryDebug, WeaponModelLoadRequest,
    WeaponStainingTemplates, apply_weapon_model_stains, load_chara_model_from_async_resource,
    load_equipment_model_from_async_resource, load_furniture_model_from_async_resource,
    load_furniture_model_from_resource, load_weapon_model_from_async_resource,
