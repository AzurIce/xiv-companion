...
- 已有 water transparency、tattoo dither alpha、GlassBlend override、outline 与 lightshaft双纹理编译/画面验证；本轮补 lightshaft alpha-test threshold fixture，后续仍需针对其它 family-specific cutout、真实 glass composition 和未获证据的 lightshaft clip 语义补 fixture。
- P0 样本 snapshot。
