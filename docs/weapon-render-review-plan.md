...
3. 渲染器：下一优先级转向 `g_Transparency` 与 characterTransparency/glass alpha 行为、真实 outline pass、toon lighting，以及 shader-family-specific scroll/flow；tile ORB/detail 权重在获得真实样本后再校准。
